...
function Payment() {
	...
	return (
		<ExtendibleDashboardTempalte navList={StudentRouteConfig}>
			<div className="Dashboard__content">
				<div className="Dashboard__heading__row mb-4 row sb vc">
				...
				<div className="Payment__card round-16 p-4 mb-2">
					...
					>
						<div className="row sb vc">
							...
							<p className="cc_22 bold Payment__card__statusText--pending">
								PENDING
							</p>
						</div>
					</motion.div>
